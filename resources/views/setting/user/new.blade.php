             ...
             <div class="col-12">
               <div class="card">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input name="name" type="text" class="form-control" id="inputUserName" placeholder="Enter Name" value="{{ old('name') }}">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input name="email" type="email" class="form-control" id="inputEmail" placeholder="Enter Email" value="{{ old('email') }}">
                  </div>
                </div>
